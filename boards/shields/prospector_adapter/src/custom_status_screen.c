...
#include "widgets/output_indicator.h"
...
static struct zmk_widget_output_indicator output_widget;
...
lv_obj_t *zmk_display_status_screen() {
    ...
    zmk_widget_output_indicator_init(&output_widget, screen);
    lv_obj_align(zmk_widget_output_indicator_obj(&output_widget), LV_ALIGN_TOP_RIGHT, -10, 8);
